...
use App\Libraries\Firebase\Auth\Token\Domain\Verifier;

class Auth implements \Kreait\Firebase\Contract\Auth
{
    ...
    public function verifySessionCookie($sessionCookie, $checkIfRevoked = false): Token
    {
        ...
        $verifiedToken = $verifier->verifySessionCookie($sessionCookie, $checkIfRevoked);
