...
namespace App\Libraries\Firebase\Auth;
...
use Throwable;
use App\Libraries\Firebase\Auth\Token\Domain\Verifier as VerifierInterface;

final class SessionCookieVerifier implements VerifierInterface
{
    ...
    public function __construct(VerifierInterface $verifier, Clock $clock)
    {
    ...
    public function verifyIdToken($token): Token
    {
        ...
        try {
            $verifiedToken = $this->verifier->verifySessionCookie($token);
